Attribute VB_Name = "Exec_InterposeFuncs"
Option Explicit
...
Function OnProgramStarted()
    ...
    '___ Name the passing bin/sort _______________________________
    TheExec.Datalog.HBRFill 1, "Bin_Pass"
    TheExec.Datalog.SBRFill 1, "Sort_Pass"
    
    TheExec.Datalog.HBRFill 99, "Bin_Error"
    TheExec.Datalog.SBRFill 99, "Sort_Error"
    
    TheExec.Datalog.HBRFill 100, "Bin_Alarm"
    TheExec.Datalog.SBRFill 100, "Sort_Alarm"
...
Private Sub CreateFolder(dirName As String)
